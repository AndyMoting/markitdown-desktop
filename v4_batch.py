"""v4_batch.py — MarkItDown GUI v4
v3 基础上 + 批量文件 + 后台线程 + 实时进度 + 结果汇总
"""
import base64
import os
import re
...
def _convert_one(filepath: str) -> tuple[bool, str, int]:
    ...
    md = MarkItDown()
    # 注意：MarkItDown 不是线程安全的，每个线程用独立实例
...
class MarkItDownApp:
    def __init__(self, root: tk.Tk):
        ...
        self.root.title("MarkItDown Converter — v4 Batch")
    ...
    def _build_ui(self):
        ...
        # ===== 文件列表 =====
        list_frame = ttk.LabelFrame(self.root, text="Files")
