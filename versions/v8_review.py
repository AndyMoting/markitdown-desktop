"""v8_review.py — MarkItDown GUI v8
v7 基础上 + 全面审查修复：线程安全、config 健壮性、PyMuPDF 开关生效、文本对比算法、
frozen 路径、PDF 重复打开、base64 错误处理、UX 改进（本地化/键盘/DPI/拖拽）
"""
import argparse
import atexit
import base64
